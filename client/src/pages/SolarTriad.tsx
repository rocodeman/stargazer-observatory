...
export default function SolarTriad() {
  ...
  const [focus, setFocus] = useState("三太阳系统");
  ...
  return (
    <main className="solar-system-page solar-triad-page">
      ...
      <div className="solar-system-stage"><TriadSunThreeScene running={running} speed={speed} onFocus={setFocus} /><div className="solar-system-caption"><span>当前聚焦</span><strong>{focus}</strong><small>拖拽旋转视角 · 滚轮缩放 · 点击光源查看</small></div></div>
      <aside className="solar-system-console">
        ...
        <button type="button" className="solar-reset" onClick={() => { setFocus("三太阳系统"); setSpeed(1); }}><RotateCcw size={14} />恢复标准速度</button>
