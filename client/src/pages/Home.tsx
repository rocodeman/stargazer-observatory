...
export default function Home() {
  ...
  return (
    <main className={`observatory ${dayMode ? "day-mode" : "night-mode"}`}>
      ...
      {allMissionsComplete && <section className="dark-forest-title" aria-label="第二部黑暗深林终局信息"><h2>欢迎进入第二部：黑暗深林</h2><div className="dark-forest-events"><span>三个太阳的异常轨道已确认</span><span>宇宙广播已穿过半人马座 α</span><span>四位科学家的最后坐标已被发现</span><span>倒计时信号完成，观测者进入黑暗深林</span></div><strong className="dark-forest-ending">未完待续</strong><a href="https://github.com/rocodeman/stargazer-observatory" target="_blank" rel="noreferrer">GitHub · rocodeman/stargazer-observatory</a></section>}
