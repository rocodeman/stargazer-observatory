...
export default function Home() {
  ...
  const [highlightClickCount, setHighlightClickCount] = useState(() => Math.min(3, Number(window.localStorage.getItem("stargazer.task.shineForYou") || 0)));
  const shineComplete = highlightClickCount >= 3;
