  ...
  return (
    <main className={`travel-page ${arrived ? "arrival-mode" : "cruise-mode"}`}>
      ...
      {!arrived ? <>
        ...
        <div className="cockpit-frame"><div className="cockpit-reticle"><span /><span /><span /><span /></div><div className="cockpit-ship"><Rocket size={18} /><span>SHIP VECTOR · 0.82c · 38,400 km/s</span></div></div>
