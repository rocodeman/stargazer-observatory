...
export default function Travel() {
  ...
  return (
    <main className={`travel-page ${arrived ? "arrival-mode" : "cruise-mode"}`}>
      ...
      <footer className="travel-footer"><span>地球时间 · 模拟模式 · {arrived ? "ORBIT VIEW" : `${progress.toFixed(1)}%`}</span></footer>
    </main>
  );
}
